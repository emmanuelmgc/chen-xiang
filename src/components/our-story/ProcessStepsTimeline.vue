      ...
      <div class="text-center mb-16">
        ...
        >
          <h2 class="text-3xl md:text-4xl font-bold text-foreground mb-4">
            {{ locale === 'ar' ? 'عملية الحرفة الدقيقة' : 'Precision Craft Process' }}
          </h2>
          <p class="text-muted-foreground text-lg max-w-2xl mx-auto">
            {{ locale === 'ar' ? 'من اختيار العود المعتق إلى الطقس النهائي: رحلة الجودة والاحترام' : 'From selecting aged Oud to the final ritual: A journey of quality and respect' }}
          </p>
        </div>
      </div>
            ...
            >
              ...
              <div class="flex items-center gap-4 mb-4">
                ...
                <h3 class="text-2xl font-bold text-foreground">
                  {{ locale === 'ar' ? step.title_ar : step.title_en }}
                </h3>
              </div>

              <!-- Description -->
              <p class="text-foreground/80 text-base leading-relaxed">
                {{ locale === 'ar' ? step.summary_ar : step.summary_en }}
              </p>
            </div>
          </div>
