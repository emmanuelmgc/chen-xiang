import { g as getWhatsAppInquiryUrl } from "./contact_info.Z-eOPvq_.js";
const PRODUCT_BADGES = {
  low_smoke: { id: "low_smoke", label_ar: "دخان منخفض", label_en: "Low Smoke", iconName: "CloudOff", color: "#0F6B54" },
  // Accent Green
  gifting: { id: "gifting", label_ar: "مثالي للإهداء", label_en: "Gifting Essential", iconName: "Gift", color: "#C4A464" },
  // Primary Gold
...
const MOCK_PRODUCTS_DATA = [
  {
    ...
    specs: {
      weight_ar: "30 عصا / 15 جم",
      weight_en: "30 Sticks / 15g",
      burnTime_ar: "40 دقيقة (للعصا)",
      burnTime_en: "40 Min (per stick)",
      smokeLevel_ar: "منخفض جداً",
      smokeLevel_en: "Very Low",
      applicableSpace_ar: "15-20 متر مربع",
      applicableSpace_en: "15-20 Sqm",
      material_ar: "خشب صندل مع لاصق نباتي",
      material_en: "Sandalwood with Vegetable Binder"
    },
    sourcing: {
      origin_ar: "قوائم بالي، اندونيسيا",
      origin_en: "Gowyem Bali, Indonesia",
      batch_number: "NAF2025Q4-001",
      year_ar: "2023 تجميع",
      year_en: "2023 Harvest",
      grade_ar: "A+",
      grade_en: "A+"
    },
    certificates: [
  ...
  },
  {
    ...
    specs: {
      weight_ar: "50 جرام",
      weight_en: "50 Grams",
      burnTime_ar: "3 ساعات إجمالي (للاستخدام المتقطع)",
      burnTime_en: "3 Hrs Total (Intermittent Use)",
      smokeLevel_ar: "تقليدي",
      smokeLevel_en: "Traditional",
      applicableSpace_ar: "50+ متر مربع",
      applicableSpace_en: "50+ Sqm",
      material_ar: "رقائق عود هندي، زيوت عطرية طبيعية، راتنجات",
      material_en: "Indian Oud Chips, Natural Oil, Resins"
    },
    sourcing: {
      origin_ar: "آسام (الهند)، غابات باتشولي (اندونيسيا)",
      origin_en: "Assam (India), Patchouli Forests (Indonesia)",
      batch_number: "BAK2025Q3-005",
      year_ar: "2024 تحضير",
      year_en: "2024 Prepared",
      grade_ar: "ممتاز",
      grade_en: "Excellent"
    },
    certificates: [
  ...
  },
  {
    ...
    specs: {
      weight_ar: "800 جرام",
      weight_en: "800 Grams",
      burnTime_ar: "تسخين مستمر حتى 3 ساعات",
      burnTime_en: "Continuous heating up to 3 hours",
      smokeLevel_ar: "بدون دخان إضافي (يعتمد على البخور)",
      smokeLevel_en: "No added smoke (Bakhoor dependent)",
      applicableSpace_ar: "أي مساحة داخلية",
      applicableSpace_en: "Any indoor space",
      material_ar: "قاعدة من النحاس المطلي بالذهب",
      material_en: "Gold-plated brass base"
    },
    sourcing: {
      origin_ar: "شنجن، الصين (بتصميم NAFHA)",
      origin_en: "Shenzhen, China (NAFHA Design)",
      batch_number: "MAB2025Q1-022",
      year_ar: "2025 إنتاج",
      year_en: "2025 Production",
      grade_ar: "الكترونيات قياسية",
      grade_en: "Standard Electronics"
    },
    certificates: [
  ...
  },
  {
    ...
    specs: {
      weight_ar: "مجموعة منوعة",
      weight_en: "Assorted Collection",
      burnTime_ar: "متنوع حسب المنتج",
      burnTime_en: "Varies by product",
      smokeLevel_ar: "منخفض ومتوسط",
      smokeLevel_en: "Low and Medium",
      applicableSpace_ar: "للأفراد والعائلة",
      applicableSpace_en: "Personal and Family Use",
      material_ar: "مزيج من العود، الراتنجات، والمعدن",
      material_en: "Mix of Oud, Resins, and Metal"
    },
    sourcing: {
      origin_ar: "مكونات مختارة من مصادر NAFHA",
      origin_en: "Curated components from NAFHA sources",
      batch_number: "GFT2025EID-C01",
      year_ar: "2025 تجميع",
      year_en: "2025 Assembly",
      grade_ar: "هدايا فاخرة",
      grade_en: "Premium Gifting"
    },
    certificates: [
  ...
  },
  {
    ...
    specs: {
      weight_ar: "40 عصا / 20 جم",
      weight_en: "40 Sticks / 20g",
      burnTime_ar: "50-60 دقيقة (للعصا)",
      burnTime_en: "50-60 Min (per stick)",
      smokeLevel_ar: "منخفض",
      smokeLevel_en: "Low",
      applicableSpace_ar: "20-30 متر مربع",
      applicableSpace_en: "20-30 Sqm",
      material_ar: "عود، مزيج التوابل، راتنج",
      material_en: "Oud, Spice Blend, Resin"
    },
    sourcing: {
      origin_ar: "غابات فيتنام، خلط في الرياض",
      origin_en: "Vietnam forests, Blended in Riyadh",
      batch_number: "NAF2026Q1-010",
      year_ar: "2025 تجميع",
      year_en: "2025 Harvest",
      grade_ar: "B++",
      grade_en: "B++"
    },
    certificates: [
  ...
  },
  {
    ...
    specs: {
      weight_ar: "300 جرام",
      weight_en: "300 Grams",
      burnTime_ar: "لا ينطبق",
      burnTime_en: "N/A",
      smokeLevel_ar: "لا ينطبق",
      smokeLevel_en: "N/A",
      applicableSpace_ar: "المساحات الداخلية/المكتب",
      applicableSpace_en: "Indoor spaces / Office",
      material_ar: "سيراميك معاد حرقه (لون الرمال)",
      material_en: "Refired Ceramic (Sand color)"
    },
    sourcing: {
      origin_ar: "ورشة فنية في جدة، السعودية",
      origin_en: "Art workshop in Jeddah, Saudi Arabia",
      batch_number: "ACC2025Q2-101",
      year_ar: "2025 إنتاج",
      year_en: "2025 Production",
      grade_ar: "حرفي",
      grade_en: "Artisanal"
...
const PRODUCTS_LIST = MOCK_PRODUCTS_DATA.map((p) => ({
  id: p.id,
  name_ar: p.name_ar,
  name_en: p.name_en,
  category: p.category,
