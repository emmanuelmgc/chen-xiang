import { defineComponent, useSSRContext, mergeProps, withCtx, renderSlot, provide, inject, computed, defineAsyncComponent, createVNode, resolveDynamicComponent, ref, onMounted, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrRenderTeleport, ssrRenderAttrs, ssrRenderVNode, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrGetDynamicModelProps } from "vue/server-renderer";
...
const _sfc_main$7 = defineComponent({ __name: "Sheet", props: { modelValue: { type: Boolean, default: false } }, emits: ["update:modelValue"], setup(__props, { expose: __expose, emit: __emit }) {
  __expose();
  const props = __props, emit = __emit;
  provide("sheet-open", props.modelValue), provide("update-sheet-open", (value) => emit("update:modelValue", value));
  const __returned__ = { props, emit };
  return Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true }), __returned__;
} });
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ssrRenderTeleport(_push, (_push2) => {
    $props.modelValue ? (_push2('<div class="fixed inset-0 z-50 bg-black/50" data-source-file="src/components/ui/sheet/Sheet.vue" data-source-line-start="30" data-source-line-end="32">'), ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent), _push2("</div>")) : _push2("<!---->");
  }, "body", false, _parent);
}
...
const _sfc_main$6 = defineComponent({ __name: "SheetContent", props: { side: { default: "right" }, class: {} }, setup(__props, { expose: __expose }) {
  __expose();
  const __returned__ = { isOpen: inject("sheet-open"), props: __props, get cn() {
    return cn;
  } };
  return Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true }), __returned__;
} });
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  $setup.isOpen ? (_push(`<div${ssrRenderAttrs(mergeProps({ class: ["fixed z-50 bg-background p-6 shadow-lg", $setup.cn({ "top-0 right-0 h-full w-80": $props.side === "right", "top-0 left-0 h-full w-80": $props.side === "left", "bottom-0 left-0 right-0 h-80": $props.side === "bottom", "top-0 left-0 right-0 h-80": $props.side === "top" }, $setup.props.class)] }, _attrs, { "data-source-file": "src/components/ui/sheet/SheetContent.vue", "data-source-line-start": "26", "data-source-line-end": "37" }))}>`), ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent), _push("</div>")) : _push("<!---->");
}
...
const _sfc_main$5 = defineComponent({ __name: "SheetTrigger", setup(__props, { expose: __expose }) {
  __expose();
  const __returned__ = { updateOpen: inject("update-sheet-open") };
  return Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true }), __returned__;
} });
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<button${ssrRenderAttrs(mergeProps(_attrs, { "data-source-file": "src/components/ui/sheet/SheetTrigger.vue", "data-source-line-start": "8", "data-source-line-end": "10" }))}>`), ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent), _push("</button>");
}
